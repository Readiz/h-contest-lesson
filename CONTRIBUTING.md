...
validator는 목차나 표 형식을 강제하지 않습니다. 기본 30개 강의는 본문의 `TODO`와 근거 없는 `linked`/`verified` 표시를 검사합니다. 참고 70개 강의의 기존 연습표는 별도 개편 대상으로 남아 있지만, 새로 작성하거나 고치는 부분에는 위 기준을 적용합니다.
