...
이 허브의 연습 흐름은 [Practice Set](pages/practice-set.md)에 모읍니다. Practice Set은 weighted partition matroid greedy를 로컬 완결형으로 제공하고, 더 복잡한 intersection/union/parity는 reference 후보로 남깁니다.
