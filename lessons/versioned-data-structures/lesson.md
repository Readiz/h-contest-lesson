...
Versioned Data Structures는 과거 상태 조회, 분기 버전 생성, rollback, 과거 연산 편집의 차이를 구분하는 자료구조 안내입니다.
...
| 방식 | 핵심 | 잘 맞는 문제 |
| --- | --- | --- |
| Full persistence | 과거 version root를 보존하고 새 branch를 만든다 | version id가 query에 직접 등장 |
