...
Matroid Parity는 원소가 짝으로 묶여 있을 때, 선택한 짝들의 원소 전체가 어떤 matroid에서 독립이 되도록 최대한 많은 짝을 고르는 모델입니다. Matching을 더 일반적인 독립성 구조 위로 올린 문제로 볼 수 있습니다.

이 레슨은 Matroid Intersection, General Matching, Linear Basis Applications 이후에 보는 그래프/조합 최적화 심화입니다.
...
- 선수 지식: Matroid Intersection, General Matching, Linear Basis Applications
