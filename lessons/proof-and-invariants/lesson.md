...
[격자 경로 DP](https://h.readiz.com/learn/dynamic-programming/state-and-transition)는 위에서 내려오는 경로 수와 왼쪽에서 들어오는 경로 수를 더합니다. 모든 경로는 두 방향 중 하나로 마지막 이동을 하므로 빠진 경로가 없습니다. 마지막 이동 방향이 달라 두 집합은 겹치지 않으므로 중복도 없습니다.
